...
namespace dotnet_toolbox.api.PackageCrawling
{
    ...
    {
        private IGetSetQuerier<NuspecParser.PackageDetails> setQuery;
        private INuspecDownload download;

        public Crawler(IGetSetQuerier<NuspecParser.PackageDetails> setQuery, INuspecDownload download)
        {
